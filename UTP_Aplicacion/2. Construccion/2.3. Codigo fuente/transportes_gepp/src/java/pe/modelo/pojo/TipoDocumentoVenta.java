...
public class TipoDocumentoVenta  implements java.io.Serializable {
    ...
    public TipoDocumentoVenta(String codigo, Usuario usuarioByIdUsuarioCreacion, Usuario usuarioByIdUsuarioModificacion, String nombre, Date fechaCreacion, Date fechaModificacion, Set puntoVentaSeries, Set documentoVentas, Set resumenVentasGrupos) {
       this.codigo = codigo;
       this.usuarioByIdUsuarioCreacion = usuarioByIdUsuarioCreacion;
