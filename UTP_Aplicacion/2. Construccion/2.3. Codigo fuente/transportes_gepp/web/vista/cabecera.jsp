        ...
        <nav>
            ...
            <ul class="nav navbar-nav" style="width: auto !important;">
                ...
                <li>
                    ...
                    <ul class="dropdown-menu dropdown-usermenu pull-right">
                        <li onclick='window.location.href = "<%= request.getContextPath()%>/vista/ventas/reportes/venta-x-placa-anual.jsp"'>
                            <a>Ventas por Placa</a>
                        </li>
                        <li onclick='window.location.href = "<%= request.getContextPath()%>/vista/ventas/reportes/venta-concar-mensual.jsp"'>
                            <a>Ventas Concar</a>
                        </li>
                    </ul>
                </li>
