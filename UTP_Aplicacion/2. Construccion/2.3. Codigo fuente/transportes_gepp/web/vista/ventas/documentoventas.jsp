                        ...
                        <div class="row clearfix">
                            <div class="col-sm-12">
                                <div class="pull-right">
                                    ...
                                    <button class="btn btn-default btn-lg" ng-click="nuevaAnulacion()"><span class="glyphicon glyphicon-scissors" data-toggle="modal" data-target="#modalAnulacion" > Anular</span></button>
                                    <button class="btn btn-default btn-lg" ng-click="nuevaNotificacion()" ><span class="glyphicon glyphicon-envelope" data-toggle="modal" data-target="#modalNotificacion"> Notificar</span></button>
                                    <button class="btn btn-default btn-lg" ng-click="hacerNotaCredito()" ><span class="glyphicon glyphicon-duplicate"> Hacer Nota de Crédito</span></button>
                                    <button class="btn btn-default btn-lg" ng-click="hacerNotaDebito()"><span class="glyphicon glyphicon-duplicate"> Hacer Nota de Débito</span></button>
                                    ...
                                    <div class="modal-body">
                                        <form class="form-horizontal" role="form" name="formAnulacion">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9" ng-class="{'has-error' : formAnulacion.anulacion.motivo.$invalid && !formAnulacion.anulacion.motivo.$pristine }">
                                                    <textarea class="form-control" ng-model="anulacion.motivo"></textarea>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
