                                ...
                                <div class="modal-body">
                                    <form class="form-horizontal" role="form" name="formItem">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <select type="text" class="form-control" ng-model="clienteTmp.entidad.tipoDocumentoEntidad" ng-options="tipoDocumentoEntidad.nombre for tipoDocumentoEntidad in tiposDocumentosEntidads track by tipoDocumentoEntidad.codigo" required>
                                                </select>    
                                            </div>
                                        </div>
                                        <div class="form-group">
